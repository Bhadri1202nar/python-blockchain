...
def generate_keys():
    global number_manufacturers, number_other_users
    number_manufacturers = simpledialog.askinteger("Input", "Enter the number of manufacturers:")
    generate_manufacturer_keys(number_manufacturers)
    
    number_other_users = simpledialog.askinteger("Input", "Enter the number of stakeholders:")
...
# Function to handle the generate keys button click
def generate_keys_click():
    generate_keys()
    menu()

# Function to handle the view blockchain button click
def view_blockchain_click():
    view_blockchain()

# Function to handle the make transaction button click
def make_transaction_click():
    make_transaction('','','')

# Function to handle the view UTXO button click
def view_UTXO_click():
    view_UTXO()

# Function to handle the mine block button click
def mine_block_click():
    mine_block()

# Function to handle the verify blockchain button click
def verify_blockchain_click():
    verify_blockchain()

# Function to handle the track item button click
def track_item_click():
    item_code = simpledialog.askstring("Input", "Enter the item code:")
    track_item(item_code)

# Function to create the menu
def menu():
    tk.Button(root, text="Generate RSA Keys", command=generate_keys_click).pack()
    tk.Button(root, text="View Blockchain", command=view_blockchain_click).pack()
    tk.Button(root, text="Enter a Transaction", command=make_transaction_click).pack()
    tk.Button(root, text="View UTXO Array", command=view_UTXO_click).pack()
    tk.Button(root, text="Mine a Block", command=mine_block_click).pack()
    tk.Button(root, text="Verify the Blockchain", command=verify_blockchain_click).pack()
    tk.Button(root, text="Track an Item", command=track_item_click).pack()
